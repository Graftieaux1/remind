...
import { Users, Calendar, ArrowLeft, Plus, Clock, Edit2, ChevronRight, Stethoscope, Pill, Heart, Dumbbell, MoreHorizontal, Trash2, QrCode, X } from 'lucide-react'
...
export default function DashboardContent() {
  ...
  const fetchUsers = async () => {
    const { data, error } = await supabase.from('users').select('*, num_boitier')
    if (error) return
    setUsers(data || [])
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-gray-500 text-sm">
                        {user.num_boitier || 'Boîtier non assigné'}
                      </p>
                    </div>
            ...
            <div className="bg-white border-b border-gray-200 px-4 py-6">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    {selectedUser.num_boitier || 'Boîtier non assigné'}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-white border border-gray-300 text-gray-900 rounded-lg py-3 px-4 font-semibold flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors active:scale-[0.98]"
                >
          ...
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900">
                QR Code - {selectedUser.prenom} {selectedUser.nom}
              </h3>
              <button
            ...
            <div className="flex justify-center mb-4">
              <Canvas
                text={`${window.location.origin}/?patient=${selectedUser.uuid}`}
                options={{
            ...
            <p className="text-sm text-gray-600 text-center">
              Scannez ce QR code pour accéder directement à la page du patient
            </p>
          </div>
        </div>
      )}
